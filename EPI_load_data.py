...
for cell_line in cell_lines:
    ...
    print("Cell line {0} has {1} EP-pairs, number of positive samples is {2}, negative is {3}, percentage postive is {4}".format(cell_line, len(X_enhancers), np.sum(labels==1), np.sum(labels==0), np.sum(labels==1)/len(labels)))
