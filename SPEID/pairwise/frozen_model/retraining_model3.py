...
cell_line = 'union'
num_epochs = 32
num_epochs_frozen = 360
batch_size = 50
training_frac = 0.9 # use 90% of data for training, 10% for testing/validation
t = datetime.now().strftime('%Y-%m-%d-%H:%M:%S')
checkpoint_path = "/home/sss1/Desktop/projects/DeepInteractions/weights/" + cell_line + "-JASPAR-" + t + ".hdf5"
...
# # Reduce learning rate by 1/5 if val_loss is stagnant for 10 epochs
...
model.fit([X_enhancer_train, X_promoter_train],
            ...
            shuffle = True,
            callbacks=[confusionmatrixfrozen],# , reduce_lr],
